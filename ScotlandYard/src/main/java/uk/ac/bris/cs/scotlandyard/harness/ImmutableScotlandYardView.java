...
//	}
    ...
    public enum TicketAbbr {
        ...
        static TicketAbbr from(Ticket ticket) {
    ...
    public static With black(int location) {
        return player(BLACK, location);
    }

    public static With red(int location) {
        return player(RED, location);
    }

    public static With green(int location) {
        return player(GREEN, location);
    }

    public static With blue(int location) {
        return player(BLUE, location);
    }

    public static With white(int location) {
        return player(WHITE, location);
    }

    public static With yellow(int location) {
        return player(YELLOW, location);
    }
