...
public final class TravelLog implements Controller, GameControl {
    ...
    @FXML
    private TableView<Entry> logTable;
    @FXML
    private TableColumn<Entry, Number> logRound;
    @FXML
    private TableColumn<Entry, Ticket> logTicket;
    @FXML
    private TableColumn<Entry, String> logLocation;
