...
public final class GameSetup implements Controller {
    ...
    // players config tab
    @FXML
    private GridPane playerEditor;
    @FXML
    private TableView<PlayerProperty> playerTable;
    @FXML
    private TableColumn<PlayerProperty, Boolean> enabled;
    @FXML
    private TableColumn<PlayerProperty, Colour> colour;
    @FXML
    private Label playerColour;
    @FXML
    private TextField playerName;
    @FXML
    private ComboBox<Integer> playerLocation;
    @FXML
    private ChoiceBox<AI> playerAI;
    @FXML
    private TableView<TicketProperty> playerTickets;
    @FXML
    private TableColumn<TicketProperty, Ticket> playerTicketType;
    @FXML
    private TableColumn<TicketProperty, Number> playerTicketCount;
    @FXML
    private StackPane playerLocationContainer;

    // round config tab
    @FXML
    private Slider timeout;
    @FXML
    private Label timeoutHint;

    @FXML
    private Spinner<Integer> roundCount;
    @FXML
    private FlowPane roundConfig;
